...
class ThermostatsControllerTest < ActionController::TestCase
  ...
  test "should get create" do
    assert_difference('Thermostat.count') do
      post :create, thermostat: {rhizome: @rhizome_create.id, element_attributes: {control_pin: "D0", power_pin: "D1"}, sensor_attributes: { data_pin: "D2", onewire_index: "0"}}
    end
    assert_redirected_to rhizomes_path
  end

  test "should get update" do
    patch :update, id:@thermostat, thermostat: {rhizome: @rhizome_create.id, element_attributes: {control_pin: "D2", power_pin: "D3"}, sensor_attributes: { data_pin: "D4", onewire_index: "0"}}
